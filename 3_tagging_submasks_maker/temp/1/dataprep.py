    ...
    def __init__(self,
        ...
        if self.is_out_sub_seq:
            ...
            self.out_sub_seq_codes = [
                [int(element) for element in tuple] for tuple in itertools.product('01', repeat=self.out_sub_seq_code_len+1)
            ]
            """
            self.out_sub_seq_code_len = self.output_seq_max_len
            self.out_sub_seq_codes = [[1 if i == j else 0 for j in range(self.out_sub_seq_code_len)] for i in range(self.out_sub_seq_code_len)]
