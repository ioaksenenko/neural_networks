...
class Datamaker:
    ...
    def single_choice_question_generate(n=1):
        ...
        for i in range(n):
            input = '<p>_</p>'
            output = ['scq_4', 'scq_4', 'scq_4', 'scq_1', 'scq_4', 'scq_4', 'scq_4', 'scq_4']
            for j in range(n):
                input += '<p>' + str(j+1) + '.' + ('=' if i == j else '~') + '_;</p>'
                output += ['scq_4', 'scq_4', 'scq_4']
                for _ in str(j+1):
                    output += ['scq_3']
                output += ['scq_3', 'scq_2,' + str(j+5), 'scq_2,' + str(j+5), 'scq_3', 'scq_4', 'scq_4', 'scq_4', 'scq_4']
            input += '<p>_</p>'
            output += ['scq_4', 'scq_4', 'scq_4', 'scq_1', 'scq_4', 'scq_4', 'scq_4', 'scq_4']
            inputs.append(input)
    ...
    def multi_choice_question_generate(n=1):
        ...
        for product in products:
            input = '<p>_</p>'
            output = ['mcq_0', 'mcq_0', 'mcq_0', 'mcq_1', 'mcq_0', 'mcq_0', 'mcq_0', 'mcq_0']
            pos_groups = [2]
            neg_groups = [2]
            ...
            for j in range(len(product)):
                ...
                output += ['mcq_0', 'mcq_0', 'mcq_0']
                for _ in str(j + 1):
                    output += ['mcq_3']
                output += ['mcq_3', 'mcq_' + element, 'mcq_' + element, 'mcq_3', 'mcq_0', 'mcq_0', 'mcq_0', 'mcq_0']
            input += '<p>_</p>'
            output += ['mcq_0', 'mcq_0', 'mcq_0', 'mcq_1', 'mcq_0', 'mcq_0', 'mcq_0', 'mcq_0']
    ...
    def text_input_question_generate(n=1):
        ...
        for i in range(n):
            input = '<p>_</p>'
            output = ['tiq_0', 'tiq_0', 'tiq_0', 'tiq_1', 'tiq_0', 'tiq_0', 'tiq_0', 'tiq_0']
            for j in range(i+1):
                input += '<p>{=_}</p><p>_</p>'
                output += ['tiq_0', 'tiq_0', 'tiq_0', 'tiq_' + str(j + 2), 'tiq_' + str(j + 2), 'tiq_' + str(j + 2), 'tiq_' + str(j + 2), 'tiq_0', 'tiq_0', 'tiq_0', 'tiq_0', 'tiq_0', 'tiq_0', 'tiq_0', 'tiq_1', 'tiq_0', 'tiq_0', 'tiq_0', 'tiq_0']
            inputs.append(input)
            outputs.append(output)
        return inputs, outputs
    ...
    def number_input_question_generate(n=1):
        ...
        for i in range(n):
            input = '<p>_</p>'
            output = ['niq_0', 'niq_0', 'niq_0', 'niq_1', 'niq_0', 'niq_0', 'niq_0', 'niq_0']
            for j in range(i + 1):
                input += '<p>{#_}</p><p>_</p>'
                output += ['niq_0', 'niq_0', 'niq_0', 'niq_' + str(j + 2), 'niq_' + str(j + 2), 'niq_' + str(j + 2), 'niq_' + str(j + 2), 'niq_0', 'niq_0', 'niq_0', 'niq_0','niq_0', 'niq_0', 'niq_0', 'niq_1', 'niq_0', 'niq_0', 'niq_0', 'niq_0']
            inputs.append(input)
            outputs.append(output)
        return inputs, outputs
    ...
    def matching_question_generate(n=1):
        ...
        for permutation in permutations:
            input = '<p>_</p>'
            output = ['mq_0', 'mq_0', 'mq_0', 'mq_1', 'mq_0', 'mq_0', 'mq_0', 'mq_0']
            for j in range(len(permutation)):
                input += '<p>' + str(j + 1) + ')_</p>'
                output += ['mq_0', 'mq_0', 'mq_0']
                for _ in str(j + 1):
                    output += ['mq_3']
                output += ['mq_3', 'mq_3', 'mq_0', 'mq_0', 'mq_0', 'mq_0']
            for j in range(len(permutation)):
                input += '<p>' + iterable[j] + ')_</p>'
                output += ['mq_0', 'mq_0', 'mq_0', 'mq_0', 'mq_0', 'mq_0', 'mq_0', 'mq_0', 'mq_0', 'mq_0']
            input += '<p>Ответ:'
            output += ['mq_0', 'mq_0', 'mq_0', 'mq_0', 'mq_0', 'mq_0', 'mq_0', 'mq_0', 'mq_0']
            for j in range(len(permutation)):
    ...
    def ordering_question_generate(n=1):
        ...
        for permutation in permutations:
            input = '<p>_</p>'
            output = ['oq_0', 'oq_0', 'oq_0', 'oq_1', 'oq_0', 'oq_0', 'oq_0', 'oq_0']
            for j in range(len(permutation)):
                input += '<p>' + str(j + 1) + ')_</p>'
                output += ['oq_0', 'oq_0', 'oq_0']
                for _ in str(j + 1):
                    output += ['oq_3']
                output += ['oq_3', 'oq_3', 'oq_0', 'oq_0', 'oq_0', 'oq_0']
            input += '<p>Ответ:'
            output += ['oq_0', 'oq_0', 'oq_0', 'oq_0', 'oq_0', 'oq_0', 'oq_0', 'oq_0', 'oq_0']
            for j in range(len(permutation)):
